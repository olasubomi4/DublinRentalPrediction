...
expected_columns = ['Wifi', 'TV', 'accommodates', 'minimum_nights',
                    'bathrooms', 'bedrooms', 'beds',
                    'total_rooms', 'room_type', 'county_Dublin 1', 'county_Dublin 10',
                    ...
                    'county_Dublin 6', 'county_Dublin 7',
                    'county_Dublin 8', 'county_Dublin 9', 'property_type_Entire bungalow',
                    'property_type_Entire cabin', 'property_type_Entire condo',
                    ...
                    'property_type_Shared room in hostel', 'property_type_Tiny home']
